export namespace CollideFuncs {
    ...
    export function hitBounds(playerBounds: Phaser.Geom.Rectangle, otherBounds: Phaser.Geom.Rectangle): boolean {
        return playerBounds.x > otherBounds.x - otherBounds.width / 2
